			...
			<div class="col-md-4 offset-md-3">
				<div class="card reg-top">
					<div class="card-header login-bg text-white text-center">
						...
						<!-- <p>Register Here</p> -->
						<p>${empty user ? 'Registration Here' : 'Update User Profile'} </p>
					</div>
					<div class="card-body">
						<form name="reg" id="reg" method="post" action="Registration"
							...
							<div class="form-group">
								<label for="mname">Middle Name : </label> <input type="text"
									class="form-control" name="mname" id="mname" value="<c:out value="${user.middleName}"/>"
							...
							<div class="form-group">
								<label for="lname">Last Name : </label> <input type="text"
									class="form-control" name="lname" id="lname" value="<c:out value="${user.lastName}"/>"
							...
							<div class="form-group">
								<label for="email">Email Id : </label> <input type="text"
									class="form-control" name="email" id="email" value="<c:out value="${user.email}"/>"
							...
							<div class="form-group">
								<label for="dob">Date Of Birth : </label> <input type="date"
									class="form-control" name="dob" id="dob" value="<c:out value="${user.dob}"/>" onblur="inputdob()"
							...
							<div class="form-group">
								<label for="m_no">Mobile No : </label> <input type="text"
									class="form-control" name="m_no" id="m_no" maxlength="10" value="<c:out value="${user.mobile_no}"/>"
							...
							<div class="check">
								<div class="form-check form-check-inline">
									...
									<div class="space">
										<input type="radio" class="form-check-input" name="gender"
											value="male"${user.gender == 'male' ? 'checked' : '' } onblur="inputgender()" onfocus="resetGender()"><label
								...
								<div class="form-check form-check-inline">
									<div class="space">
										<input type="radio" class="form-check-input" name="gender"
											value="female" ${user.gender == 'female' ? 'checked' : '' } onblur="inputgender()" onfocus="resetGender()"><label
							...
							<div class="check mb-4 mt-5">
								<div class="form-check form-check-inline">
									...
									<div class="space">
										<input type="checkbox" class="form-check-input"
											name="language" value="gujarati" ${user.language == 'gujarati' ? 'checked' : '' } onblur="inputlanguage()"
								...
								<div class="form-check form-check-inline">
									<div class="space">
										<input type="checkbox" class="form-check-input"
											name="language" value="hindi" ${user.language == 'hindi' ? 'checked' : '' } onblur="inputlanguage()"
											onfocus="resetLanguage()"> <label
								...
								<div class="form-check form-check-inline">
									<div class="space">
										<input type="checkbox" class="form-check-input"
											name="language" value="enghlish" ${user.language == 'enghlish' ? 'checked' : '' } onblur="inputlanguage()"
											onfocus="resetLanguage()"> <label
							...
							<div class="form-group">
								<label for="hobbie">Hobbies : </label> <select name="hobbie"
									...
									<optgroup label="Game">
										<option value=""></option>
										<option value="CSGO" ${user.hiobbie == 'CSGO' ? 'selected' : '' }>CSGO</option>
										<option value="PUBG" ${user.hiobbie == 'PUBG' ? 'selected' : '' }>PUBG</option>
									</optgroup>
									<optgroup label="Movie">
										<option value="Bollywood" ${user.hiobbie == 'Bollywood' ? 'selected' : '' }>Bollywood</option>
										<option value="Hollywood" ${user.hiobbie == 'Hollywood' ? 'selected' : '' }>Hollywood</option>
									</optgroup>
							...
							<div class="form-group">
								<label for="pwd">Password : </label> <input type="Password"
									class="form-control" name="pwd" id="pwd" value="<c:out value="${user.password}"/>" placeholder="Enter Password"
							...
							<div class="form-group">
								<label for="cpwd">Confirm Password : </label> <input
									type="Password" class="form-control" name="cpwd" id="cpwd" value="<c:out value="${user.password}"/>"
							...
							<div class="form-group">
								...
								<div class="d-flex">
									...
									<img id="preview" class="rounded float-right" <c:if test="${user.image != null}">src="image/${user.image}"</c:if>><br>
								</div>

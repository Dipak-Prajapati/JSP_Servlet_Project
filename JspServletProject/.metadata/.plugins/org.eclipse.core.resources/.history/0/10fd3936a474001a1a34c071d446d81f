							...
							<form name="reg" method="post" action="Registration"
								...
								<div class="form-group">
									<label for="lname">Last Name : </label> <input type="text"
										...
										onfocus="resetLastName()"><br> <span
										class="error" id="slname"></span>
								</div>
								...
								<div class="check">
									...
									<div class="form-check form-check-inline">
										<div class="space">
											<input type="radio" class="form-check-input" name="gender"
												value="female" onblur="inputgender()"
												onfocus="resetGender()"><label
								...
								<div class="form-group">
									...
									<textarea class="form-control"
										placeholder="10/4 mahashakti nagar society" name="address" id="address"
										onblur="inputaddress()" onfocus="resetAddress()"></textarea>

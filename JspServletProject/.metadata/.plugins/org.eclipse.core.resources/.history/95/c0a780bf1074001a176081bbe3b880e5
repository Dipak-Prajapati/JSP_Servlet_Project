...
public class RegisterPojo {
	...
	public String toString() {
		return "RegisterPojo [ firstName=" + firstName + ", middleName=" + middleName + ", lastName="
				+ lastName + ", email=" + email + ", dob=" + dob + ", mobile_no=" + mobile_no + ", gender=" + gender
				+ ", language=" + language + ", hiobbie=" + hiobbie + ", password=" + password + "]";
	}
